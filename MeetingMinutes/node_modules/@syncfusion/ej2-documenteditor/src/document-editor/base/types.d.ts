 ...
 */
export declare type ToolbarItem = 'New' | 'Open' | 'Separator' | 'Undo' | 'Redo' | 'Comments' | 'Image' | 'Table' | 'Hyperlink' | 'Bookmark' | 'TableOfContents' | 'Header' | 'Footer' | 'PageSetup' | 'PageNumber' | 'Break' | 'Find' | 'LocalClipboard' | 'RestrictEditing';
